            ...
            {products &&
              Object.keys(products).map((item) => {
                return (
                  ...
                  >
                    <div className="lg:w-1/5 md:w-1/2 p-4 w-full shadow-md lg:mx-6 lg:my-2 " data-aos="fade-up" data-aos-duration="2000" >
...
export async function getStaticProps({ params }) {
  return {
    props: { products: toysmore }, // will be passed to the page component as props
  };
}
