                      ...
                      <div className="mt-4 text-center">
                        ...
                        <div className="mt-1 ">
                         <ul className="text-xs text-start flex flex-col ml-4 space-y-1 font-medium font-sans text-zinc-500 list-disc">
                            ...
                            {products[item].info3 && <li>{products[item].info3}</li>}
                            {products[item].info4 && <li>{products[item].info4}</li>}
...
export async function getStaticProps({ params }) {
  return {
    props: { products: appliances }, // will be passed to the page component as props
  };
}
