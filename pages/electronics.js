            ...
            {products &&
              Object.keys(products).map((item) => {
                return (
                  ...
                  >
                    <div className="lg:w-1/5 md:w-1/2 p-4 w-full shadow-md lg:mx-6 lg:my-2 " data-aos="zoom-in-right" data-aos-duration="2000" >
                      <a className="block relative transition duration-700 ease-in-out hover:scale-110 scroll-smooth  rounded overflow-hidden">
                       <picture>
                       <img
                          alt="ecommerce"
                          className="md:h-[28vh] block h-[32vh] m-auto"
...
export async function getStaticProps({ params }) {
  return {
    props: { products: electronics }, // will be passed to the page component as props
  };
}
